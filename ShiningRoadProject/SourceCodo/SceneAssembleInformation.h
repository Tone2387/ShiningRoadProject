...
{
	enGIGANT_WEAPONS_CONTROLLER_X		= enPKey_06,
	enGIGANT_WEAPONS_CONTROLLER_Y		= enPKey_07,
	enGIGANT_WEAPONS_CONTROLLER_START	= enPKey_05,
	enGIGANT_WEAPONS_CONTROLLER_BACK	= enPKey_04,
};
